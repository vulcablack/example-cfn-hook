# Personal::Testing::Hook

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `personal-testing-hook.json`
2. Implement your resource handlers in `personal_testing_hook/handlers.py`
